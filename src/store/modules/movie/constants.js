...
export const GET_BY_TITLE = {
	REQUEST: `${customModule}/GET_BY_TITLE_REQUEST`,
	SUCCESS: `${customModule}/GET_BY_TITLE_SUCCESS`,
	FAILURE: `${customModule}/GET_BY_TITLE_FAILURE`
}

export const GET_PAGE = {
	REQUEST: `${customModule}/GET_PAGE_REQUEST`,
